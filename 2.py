...
pagesENG = re.sub(
    r'(\n|\t)+', '.', pages_eng)
pagesENG = nltk.download(pagesENG)

with open('C:/Users/WHITE SKIN/Desktop/pjn/english.txt', 'w', encoding='utf-8') as file:
    for item in pagesENG:
        file.write("%s\n" % item)

call('LF_aligner_4.2.exe --filetype="t" --infiles="C:/Users/WHITE SKIN/Desktop/pjn/english.txt","C:/Users/WHITE SKIN/Desktop/pjn/polish.txt" --languages="en","pl" --segment="y" --review="n" --tmx="n"')
